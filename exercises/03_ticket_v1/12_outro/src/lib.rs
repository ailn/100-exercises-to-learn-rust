...
impl Order {
    ...
    pub fn set_product_name(&mut self, new_name: String) {
        Self::verify_product_name(&new_name);
    ...
    pub fn set_quantity(&mut self, new_qty: u32) {
        Self::verify_quantity(&new_qty);
    ...
    pub fn set_unit_price(&mut self, new_price: u32) {
        Self::verify_unit_price(&new_price);
    ...
    fn verify_product_name(name: &String) {
        if name.is_empty() {
    ...
    fn verify_unit_price(price: &u32) {
        if *price == 0 {
